package com.trpoal.blurdetection;
...
import com.trpoal.blurdetection.helpers.ImageSource;
import com.trpoal.blurdetection.helpers.SubsamplingScaleImageView;
import com.trpoal.blurdetection.helpers.Classifier;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void floatButtonClick(View view) {
        ...
        if (photoFile != null) {
            Uri imageUri = FileProvider.getUriForFile(this, "com.trpoal.blurdetection.provider", photoFile);
                                ...
                                () -> {
                                    if (finalBlurCount >= bitmaps.size() / 2) {
                                        ...
                                        new AlertDialog.Builder(this)
                                                ...
                                                .setPositiveButton("Переделать", (dialog, id) -> floatButtonClick(null))
